...
class Biochemistry extends MY_Controller {
	 ...
	 public function __construct() {
             ...
             $this->load->model('biochemestrypatient_model');
         }
	...
	public function index()
	{
        ...
        $biochemstryList=array();
        $biochemstryList = $this->biochemestrypatient_model->fetch();
        $this->data['biochemstryList']=$biochemstryList;
        $this->load->view('biochemestry/list',$this->data);
	...
	public function addstep1()
	{
            ...
            $this->load->view('biochemestry/addstep1',$this->data);
            $this->load->view('common/footer',$this->data);
	}
