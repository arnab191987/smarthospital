              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/bill/addstep4/<?php echo $bill_no; ?>/<?php echo $mode; ?>" method="post">
			<div class="alert alert-success" <?php if($success_msg!=""){ ?> style="display: block;" <?php }else{ ?> style="display: none;"<?php } ?>>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="service[service_name]" required="required">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="bed_no" name="service[qty]" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <?php if($mode=="edit"){ ?>
                          <a class="buttonPrevious buttonDisabled btn btn-primary" href="<?php echo base_url(); ?>index.php/bill/billdetails/<?php echo $bill_no; ?>">Complete </a>
                          <?php } ?>
                          <button type="submit" class="btn btn-success">Submit</button>
                          <a class="buttonPrevious buttonDisabled btn btn-primary" href="<?php echo base_url(); ?>index.php/bill/addstep5/<?php echo $bill_no; ?>">Next >></a>
                        </div>
