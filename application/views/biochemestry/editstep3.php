          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                     <h2>Update Service details of Bill No. <?php echo $bill_no; ?></h2>
                  ...
                  <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/bill/editservicedinfo/<?php echo $bill_no; ?>/<?php echo $info['id']; ?>" method="post">
			<div class="alert alert-success" <?php if($success_msg!=""){ ?> style="display: block;" <?php }else{ ?> style="display: none;"<?php } ?>>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" id="service_name" name="service[service_name]" required="required">
                            <option>Choose option</option>
                            <?php foreach ($serviceList as $key => $value) { ?>
                                    <?php 
                                        if($value['service_name']==$info['service_name']){ 
                                            $selected="selected";
                                        }
                                        else{
                                            $selected="";
                                    ...
                                    ?>
                                    <option value="<?php echo $value['service_id'] ?>" <?php echo $selected; ?>><?php echo $value['service_name'] ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control" readonly="readonly" id="serviceCharge" type="text" value="<?php echo "Rs. ".$info['service_charge']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="qtyservice" name="service[qty]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $info['qty'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
