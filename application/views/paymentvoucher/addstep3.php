          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <h2>Add Payment Voucher details<small>Entry of paid amount</small></b></h2>
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/paymentvoucher/addstep3" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="voucher[debit]" required="required" class="form-control col-md-7 col-xs-12" value="">
                              <input type="hidden" id="name" name="voucher[party]" class="form-control col-md-7 col-xs-12" value="<?php echo $supplier_ledger; ?>">
