          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                     <h2>Update Equipment details of Bill No. <?php echo $bill_no; ?></h2>
                  ...
                  <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/bill/editmachinaryinfo/<?php echo $bill_no; ?>/<?php echo $info['id']; ?>" method="post">
			<div class="alert alert-success" <?php if($success_msg!=""){ ?> style="display: block;" <?php }else{ ?> style="display: none;"<?php } ?>>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="machine[machine_name]" id="machineName" required="required">
                            <option>Choose option</option>
                            <?php foreach ($machineList as $key => $value) { ?>
                                    <?php 
                                        if($value['equipement_name']==$info['machine_name']){ 
                                            $selected="selected";
                                        }
                                        else{
                                            $selected="";
                                    ...
                                    ?>
                                    <option value="<?php echo $value['equipement_name'] ?>" <?php echo $selected; ?>><?php echo $value['equipement_name'] ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control" readonly="readonly" id="machinaryCharge" type="text" value="<?php echo "Rs. ".$info['charge']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="machine[qty]" id="qtymachine" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $info['qty'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
