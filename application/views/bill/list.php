                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                             <a href="<?php echo base_url(); ?>index.php/bill/billdetails/<?php echo $value['bill_no'] ?>" class="btn btn-info btn-xs"><i class="fa fa-folder"></i> View </a>
                             <a href="<?php echo base_url(); ?>index.php/bill/deletebill/<?php echo $value['bill_no'] ?>/<?php echo $value['bill_id'] ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                            </td>
                        </tr>
                        <?php } ?>
