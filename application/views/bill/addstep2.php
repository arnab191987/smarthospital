              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/bill/addstep3/<?php echo $bill_no; ?>" method="post">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class="buttonPrevious buttonDisabled btn btn-primary" href="<?php echo base_url(); ?>index.php/bill/addstep3/<?php echo $bill_no; ?>">Next >></a>
                        </div>
                      </div>
