            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/reciptvoucher/mrregister/" method="post">
                    ...
                    <div class="alert alert-success" <?php if($success_msg!=""){ ?> style="display: block;" <?php }else{ ?> style="display: none;"<?php } ?>>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Vouchar No <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="reciptvoucher[vouchar_no]" id="qtydoctor" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="birthday_to" name="reciptvoucher[to_date]" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success">Search Vouchar</button>
                        </div>
                      </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered  billReg">
                      ...
                      <tbody>
                        <?php
                            ...
                            $total=0;
                        ?>
                        <?php foreach ($voucharList as $key => $value) { ?>
                        <tr>
                            <td><?php echo $sl; ?></td>
