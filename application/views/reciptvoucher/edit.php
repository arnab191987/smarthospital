          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <h2>Update Recipt Voucher details of <?php echo $voucher ?><small>Entry of deposit amount</small></b></h2>
                  ...
                  <div class="x_content">
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/reciptvoucher/edit/<?php echo $voucher;  ?>" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" readonly="" id="name" name="" class="form-control col-md-7 col-xs-12" value="<?php echo $reciptvoucherDetails['0']['party']; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="name" name="voucher[credit]" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $reciptvoucherDetails['0']['credit']; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" name="voucher[mode]" required="required">
                              ...
                              <?php foreach ($paymentModeList as $key => $value) { ?>
                                    <?php 
                                        if($reciptvoucherDetails['0']['mode']==$value['id']){
                                            $selected="selected";
                                        }
                                        else{
                                            $selected="";
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" name="voucher[posting_ledger]" required="required">
                              ...
                              <?php foreach ($ledgerList as $key => $value) { ?>
                                    <?php 
                                        if($reciptvoucherDetails['0']['posting_ledger']==$value['id']){
                                            $selected="selected";
                                        }
                                        else{
                                            $selected="";
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <textarea id="message" name="voucher[narration]" required="required" class="form-control" name="message" data-parsley-trigger="keyup"   data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                            data-parsley-validation-threshold="10"><?php echo $reciptvoucherDetails['0']['narration']; ?></textarea>
                        </div>
                       </div>
