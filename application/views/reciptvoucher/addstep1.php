          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <h2>Add Recipt Voucher details<small>Find by IPD/OPD</small></h2>
                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Search by <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="radio">
                            <label>
                              <input value="ipd" id="optionsRadios1" name="admission[recipt_voucher_type]" type="radio"> <span style="display: inline-block;padding: 3px"><b>IPD</b></span>
                            </label>
                            <label>
                              <input value="opd" id="optionsRadios1" name="admission[recipt_voucher_type]" type="radio"> <span style="display: inline-block;padding: 3px"> <b>OPD</b></span>
                            </label>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">IPD/OPD No. <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
