<div class="printMRWrapper">
    <table style="width: 100%,margin: 0 auto;border : 2px solid #000;border-collapse:collapse" >
     	...
     	<tr><td colspan="5" align="center" style="border-bottom: 2px solid #000;"><b>Money Recipt
        <?php 
            if($reciptvoucherDetails['recipt_voucher_type']!=""){
                echo "(".strtoupper($reciptvoucherDetails['recipt_voucher_type']).")";
            }
        ?></b></td></tr>
     	<tr><td colspan="5" align="center"><h1></h1></td></tr>
        <tr><td align="center"><div style="display: block;margin-top: 10px;">Voucher No : <?php echo $reciptvoucherDetails['voucher_no'] ?></div></td><td></td><td align="center" colspan="3"><div style="display: block;margin-top: 10px;">Date and Time: <?php echo $reciptvoucherDetails['reciptvouchar_date'] ?></div></td></tr>
         <tr><td align="center"><div style="display: block;margin-top: 4px;">Received with thanks  : Rs.<?php echo $reciptvoucherDetails['credit'] ?></div></td><td></td><td align="center" colspan="3"><div style="display: block;margin-top: 10px;">IPD/OPD No : <?php echo $reciptvoucherDetails['party'] ?></div></td></tr>
