              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        <li>
                          <a href="#step-1" class="done">
                            ...
                            <span class="step_descr">
                                              Step 1<br />
                                              <small>Find details by IPD/OPD</small>
                                          </span>
                          </a>
                        </li>
                        <li>
                            ...
                            <span class="step_descr">
                                              Step 2<br />
                                              <small>Details of admission/patient</small>
                                          </span>
                          </a>
                        </li>
                        <li>
                      ...
                      <?php if($recipt_voucher_type=="ipd"){ ?>
                      <div class="form-group">
                      ...
                      <?php }else{ ?> 
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Date Of OPD <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="birthday" class="date-picker form-control col-md-7 col-xs-12" name="admission[patient_admission_date]" required="required" type="text" value="<?php echo $details['patient_opd_date']; ?>">
                          <input id="birthday" class="date-picker form-control col-md-7 col-xs-12" name="admission[ipd_no]" type="hidden" value="<?php echo $details['opd_no']; ?>">
                        </div>
                      </div>
                      <?php } ?>
                       <input id="recipt_voucher_type" class="date-picker form-control col-md-7 col-xs-12" name="admission[recipt_voucher_type]" type="hidden" value="<?php echo $recipt_voucher_type; ?>">
