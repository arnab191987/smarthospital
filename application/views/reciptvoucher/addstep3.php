                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $base_url; ?>index.php/reciptvoucher/addstep3" method="post">
                        <input id="recipt_voucher_type" class="date-picker form-control col-md-7 col-xs-12" name="voucher[recipt_voucher_type]" type="hidden" value="<?php echo $recipt_voucher_type; ?>">
